jQuery(document).ready(function(){
	...
	jQuery(document).ready(function(){
		function setTematikaIcons(){
			jQuery('.tematika-lista li.closed i').text('add')
			jQuery('.tematika-lista li.opened i').text('remove')
		}
		...
		jQuery('.unfold i').click(function(){
			if(jQuery(this).text() == 'unfold_less'){
				...
				jQuery('.tematika-lista li').removeClass("opened").addClass('closed')
			}else{
				jQuery(this).text('unfold_less')
				jQuery(this).parent().find('span').text("Összeset becsuk")
				jQuery('.tematika-lista li').removeClass("closed").addClass('opened')
			}
			setTematikaIcons()
		})
	})
